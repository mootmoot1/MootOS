...
2026. This document is a plan, not an implementation record — as of this
writing, none of V0.3A–V0.3E or V0.4A–V0.4D exists in code. Only the V0.2A
Tool System (`docs/TOOL_SYSTEM.md`) is implemented and merged.
