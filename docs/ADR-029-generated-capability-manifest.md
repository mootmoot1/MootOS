...
as part of V0.3A, pending merge. Recorded August 9, 2026, as part of the
V0.3/V0.4 architecture lock. See `docs/CAPABILITY_ARCHITECTURE.md` §5 and
`docs/TOOL_SYSTEM.md` §16 for the concrete result
